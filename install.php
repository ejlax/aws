	...
	<div id="mainForm">
		...
		<div id="formHeader">
				<h2 class="formInfo">Registration Form</h2>
				<p class="formInfo"></p>
		</div>
 ...
 if(isset($_POST['submit']))
  {
	 ...
	 field_3 TEXT ,
	 field_4 TEXT ,
	 field_5 TEXT )") or die("Error! Table not be created.");
