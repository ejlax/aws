...
<html>
	...
	<body onLoad="focuslogin()">
		...
		<div id="mainForm">
			<div id="formHeader">
				<h2 class="formInfo">Pearson AWS Portal</h2>
				<p class="formInfo"></p>
			</div>
			<BR/>
			<!-- begin form -->
			<form name="login" method=post action='' onsubmit="return validatePage1()" >
				<table border="0" cellspacing="0" cellpadding="2" width="340" bgcolor="white" align="center">
					...
					{
					retVal = true;
					if (validateField('email','fieldBox_1','text',1) == false)
					retVal=false;
					if (validateField('password','fieldBox_2','text',1) == false)
					retVal=false;
